    ...
    <div className="assets-container">
      {headers.map((header) => (
        <div key={header} className="assets-section">
          <h3>{header}
            {formData[header] ? 
              <span onClick={() => handleAdd(header)} className="assets-remove-icon">-</span> :
              <span onClick={() => handleAdd(header)} className="assets-add-icon">+</span>
            }
          </h3>
        ...
        <div className="assets-section">
                <h3>Total Assets</h3>
                <div className='asset-item'>${computeTotal()}</div>
            </div>
    </div>
